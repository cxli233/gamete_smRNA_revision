...
ggplot(aes(x = bin.start, y= methylation)) +
  ...
  scale_color_manual(values = c("green4", "magenta3", "orangered3", "lightgoldenrod4"),
                     limits = c("bract", "embryo", "ovary", "endosperm")) +
...
ab <- g1_g3 %>%
  ...
  scale_color_manual(values = c("tomato4", "tomato1", "tomato2", NA, 
                                ...
                                "green4", "magenta3", "lightgoldenrod4", "orangered3"
                                   ...
                                   "bract", "embryo", "endosperm", "ovary")) +
  theme_minimal() +
  theme(legend.position = "none", strip.placement = "outside", legend.box = "vertical", legend.spacing.y = unit(-1, "lines")) +
  theme(text = element_text(size = 18, face="bold")) +
  theme(axis.text.y = element_text(colour="black")) +
  theme(strip.text.x = element_blank()) +
  theme(legend.key.width = unit(3, "lines")) +
...
```{r}
cd <- plot_grid(NULL, c, NULL, d, NULL, 
          rel_widths = c(0.25 ,1, 0, 1, 0.03), 
          nrow = 1)

plot_grid(ab,NULL, cd, 
          rel_heights = c(1, 0.4, 1), 
          rel_widths = c(1, 0.1, 1), 
          nrow = 2)

ggsave("fig4ab_new.svg", height = 5, width = 10)
ggsave("fig4ab_new.png", height = 5, width = 10)
```
